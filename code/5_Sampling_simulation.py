...
sampled_hologram_intensity = downscale_local_mean(hologram_intensity, (decimation_factor, decimation_factor))
sampled_hologram_amplitude = np.sqrt(sampled_hologram_intensity)
plot_image(sampled_hologram_amplitude, "Sampled hologram amplitude")

# Create the sensor grid
numPixels_sensor = sampled_hologram_amplitude.shape[0]
...
# IPR reconstruction
rec_field = IPR(W_sen,H_sen,wavelength,z2,pitch_size[1],numPixels_sensor,sampled_hologram_amplitude,50)
